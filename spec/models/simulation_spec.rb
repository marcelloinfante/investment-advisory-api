...
RSpec.describe Simulation, type: :model do
  describe "validations" do
    context "presence" do
      ...
      it { should validate_presence_of(:is_worth) }
      ...
      it { should validate_presence_of(:years_to_expire) }
      it { should validate_presence_of(:agio_percentage) }
      it { should validate_presence_of(:final_variation) }
      it { should validate_presence_of(:remaining_mounths) }
      ...
      it { should validate_presence_of(:year_to_expire_with_new_rate) }
      it { should validate_presence_of(:new_rate_final_value_same_period) }
      it { should validate_presence_of(:final_value_with_new_rate_at_new_period) }
    end
  end
end
