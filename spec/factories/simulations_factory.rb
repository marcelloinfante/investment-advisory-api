FactoryBot.define do
  factory :simulation do
    ...
    years_to_expire{ Faker::Number.decimal(l_digits: 2, r_digits: 2) }
    agio_percentage { Faker::Number.decimal(l_digits: 2, r_digits: 2) }
    final_variation { Faker::Number.decimal(l_digits: 2, r_digits: 2) }
    remaining_mounths { Faker::Number.decimal(l_digits: 2, r_digits: 2) }
    ...
    year_to_expire_with_new_rate { Faker::Number.decimal(l_digits: 2, r_digits: 2) }
    new_rate_final_value_same_period { Faker::Number.decimal(l_digits: 2, r_digits: 2) }
    final_value_with_new_rate_at_new_period { Faker::Number.decimal(l_digits: 2, r_digits: 2) }
  end
end
